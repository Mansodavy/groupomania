 ...
 // Rendu des posts et des 3 dernier commentaires associés à chaque post 
    ...
    return (
      ...
      <section >
        ...
        <figure class="image is-128x128 is-inline-block">
            <img  width={100} height={100} alt={post.nomposte} src={post.user.imageUrl}></img>
        </figure>
    </div>
							<h4 className="has-text-centered"><strong>{post.nomposte}</strong></h4>
              <p className="has-text-centered">{post.messagepost}
              </p>
						</article>
					</div>
				</div>        
  ...
  <figure class="media-left">
    <p class="image is-64x64">
      <img src={commentaire.user.imageUrl}/>
    </p>
  </figure>
  <div class="media-content">
    ...
    <p >
                     {commentaire.commentaire}
                                <br/>
                                <strong>{commentaire.user.nom}</strong> <strong>{commentaire.user.prenom}</strong>
                              </p>
    </div>
  </div>
</article>               
